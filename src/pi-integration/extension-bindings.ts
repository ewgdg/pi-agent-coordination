...
export async function refreshNativeExtensionBindings(
	...
	// Pi's retained-session rebind rebuilds the TUI but calls bindExtensions(),
	// which would replay session_start. Capture fresh host callbacks while
	// preserving the already-started extension lifecycle.
