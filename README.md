...
See [Owner Workflow](docs/owner-workflow.md) for activation and compatibility behavior, [Agent spawning](docs/agent-spawning.md) for child creation and receipt semantics, and [Agent messaging](docs/agent-messaging.md) for delivery modes, Requests, Answers, retrieval, cancellation, bounded scheduling, and dormant Run restart.
